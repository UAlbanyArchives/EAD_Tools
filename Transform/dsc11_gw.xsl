...
for each level.-->
	...
	<xsl:template match="c01/did">
		...
		<xsl:variable name="first" select="container[@type='Box' or
			@type='Oversized' or @type='Video-Tape' or @type='DVD' or @type='Cassette' or @type='Flat-File']"/>
		...
		<xsl:variable name="preceding" select="preceding::did[1]/container[@type='Box' or @type='Oversized' or @type='Video-Tape' or @type='Mini-DV' or @type='Reel' or @type='DVD' or @type='Cassette' or @type='Card-File' or @type='File' or @type='Artifact-box' or @type='Flat-File']"/>
