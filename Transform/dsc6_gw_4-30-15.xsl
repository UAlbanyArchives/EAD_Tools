...
that is used generically throughout the stylesheet.-->
	...
	<xsl:template name="uid">
		<!--Inserts @id and a space if it exists in the markup.-->
		<xsl:if test="../@id">
			<span style="display:none;font-weight:bold;font-size:11px;line-height:20px">
				<xsl:text>&#x20;</xsl:text>
				<xsl:value-of select="substring-after(../@id, 'nam_')"/>
				<xsl:text>&#x20;</xsl:text>
			</span>
		</xsl:if>
	</xsl:template>
			...
			<xsl:when test="dao">
				...
				<xsl:choose>
					...
					<xsl:when test="unittitle/unitdate">
						<xsl:apply-templates select="unittitle/*[not(self::unitdate)]"/>
						<xsl:text>,&#x20;</xsl:text>
			...
			unittitle and where it is a separate child of did.-->
				<xsl:choose>
					...
					<xsl:otherwise>
						...
						<xsl:if test="unittitle!=unitdate">
							<xsl:text>,&#x20;</xsl:text>
							<xsl:for-each select="unitdate">
								<xsl:apply-templates/>
								<xsl:if test="following-sibling::unitdate"><xsl:text>,</xsl:text></xsl:if>
...
for each level.-->
	...
	<xsl:template name="c01-level">
		...
		the listed elements.-->
			<xsl:for-each select="bioghist | userestrict | accessrestrict | processinfo |
	...
	<xsl:template name="c02-level-container">
		...
		Add or subtract container types to fix institutional practice.-->
			<xsl:variable name="first" select="container[@type='Box' or @type='Oversized' or @type='Video-Tape' or @type='VHS' or @type='Umatic' or @type='Phonograph-Record' or @type='3.5in-Floppy' or @type='Film' or @type='Cassette' or @type='Audiotape-Box' or @type='Card-File' or @type='Flat-File' or @type='Artifact-Box' or @type='Map-Tube' or @type='Glass-Plates' or @type='Record' or @type='Reel' or @type='DVD' or @type='CD' or @type='CD-R' or @type='Zip-Disk' or @type='Floppy-Disk']"/>
		...
		Add or subtract container types to fix institutional practice.-->
			...
			<xsl:variable name="preceding" select="preceding::did[1]/container[@type='Box' or @type='Oversized' or @type='Film' or @type='Cassette' or @type='Audiotape-Box' or @type='Card-File' or @type='Flat-File' or @type='Artifact-Box' or @type='Reel' or @type='Frame' or @type='Page']"/>
		...
		<xsl:choose>
			...
			not($preceding/@type=$first/@type)">
					...
					<tr>
					<td class="toggle" valign="top">
						<xsl:apply-templates select="$first"/><xsl:call-template name="uid"/>
					</td>
					<td valign="top">
			...
			<xsl:otherwise>
				<tr>
					<td class="toggle" valign="top"><xsl:call-template name="uid"/></td>
					<td valign="top">
	...
	<xsl:template name="c03-level-container">
		...
		may appear in the first column of a two column container list.
		Add or subtract container types to fix institutional practice.-->
			<xsl:variable name="first" select="container[@type='Box' or @type='Oversized' or @type='Flat-File' or @type='Film' or @type='Map-Tube' or @type='Card-File' or@type='Artifact-Box']"/>
		...
		<xsl:variable name="preceding" select="preceding::did[1]/container[@type='Box' or @type='Oversized' or @type='Flat-File' or @type='Film' or @type='Reel']"/>
	...
	associated containers, for example if the c03 is a subseries.  The
	various subelements are all indented one column to the right of c01.-->
	...
	<xsl:template name="c04-level">
		...
		may appear in the first column of a two column container list.
		Add or subtract container types to fix institutional practice.-->
			<xsl:variable name="first" select="container[@type='Box' or @type='Oversized' or @type='Video-Tape' or @type='VHS' or @type='Umatic' or @type='Phonograph-Record' or @type='3.5in-Floppy' or @type='Film' or @type='Cassette' or @type='Audiotape-Box' or @type='Card-File' or @type='Flat-File' or @type='Artifact-Box' or @type='Map-Tube' or @type='Glass-Plates' or @type='Record' or @type='Reel' or @type='DVD' or @type='CD' or @type='Floppy-Disk']"/>
	...
	<xsl:template name="c07-level">
		...
		may appear in the first column of a two column container list.
		Add or subtract container types to fix institutional practice.-->
			<xsl:variable name="first" select="container[@type='Box' or @type='Oversized' or @type='Volume' or @type='Carton' or @type='Cassette-Box' or @type='Card-File']"/>

		<!--This variable defines the set of container types that
		may appear in the second column of a two column container list.
		Add or subtract container types to fix institutional practice.-->
			<xsl:variable name="second" select="container[@type='Folder' or @type='Frame' or @type='Page'  or @type='Reel' or @type='Tape']"/>

			<xsl:variable name="preceding" select="preceding::did[1]/container[@type='Box' or @type='Oversized' or @type='Volume' or @type='Carton' or @type='Cassette-Box' or @type='Card-File']"/>
	...
	<xsl:template name="c08-level">
		...
		<xsl:choose>
			...
			not($preceding/@type=$first/@type)">
				...
				<tr>
					<td class="toggle" valign="top">
						<xsl:value-of select="$first"/><xsl:call-template name="uid"/>
					</td>
					<td valign="top">
						<xsl:apply-templates select="$second"/>
					</td>
	...
	<xsl:template name="c09-level">
		...
		may appear in the first column of a two column container list.
		Add or subtract container types to fix institutional practice.-->
			<xsl:variable name="first" select="container[@type='Box' or @type='Oversized' or @type='Volume' or @type='Carton' or @type='Reel' or @type='Cassette-Box' or @type='Card-File']"/>
			<xsl:variable name="preceding" select="preceding::did[1]/container[@type='Box' or @type='Oversized' or @type='Volume' or @type='Carton' or @type='Reel']"/>

		<!--This variable defines the set of container types that
		may appear in the second column of a two column container list.
		Add or subtract container types to fix institutional practice.-->
		<xsl:variable name="second" select="container[@type='Folder' or @type='Frame' or @type='Page' or @type='Tape']"/>
	...
	<xsl:template name="c10-level">
		...
		Add or subtract container types to fix institutional practice.-->
			<xsl:variable name="first" select="container[@type='Box' or @type='Oversized' or @type='Volume' or @type='Carton' or @type='Reel' or @type='Cassette-Box' or @type='Card-File']"/>
		<xsl:variable name="preceding" select="preceding::did[1]/container[@type='Box' or @type='Volume' or @type='Carton' or @type='Reel' or @type='Tape']"/>
